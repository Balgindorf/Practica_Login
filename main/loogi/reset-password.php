...
<head>
    ...
    <title>Nueva contraseña - HokWorks</title>
...
<body>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-middle resp-margin">
                                            ...
                                            <div class="form-group">
                                                <input type="password" required name="password" id="password" class="form-control" placeholder="Nueva contraseña">
                                            </div>
                                            <div class="form-group">
                                                <input type="password" required name="confirm_password" id="confirm_password" class="form-control" placeholder="Confirma la nueva contraseña">
    ...
    function showToast(type, title, message, link = null) {
        ...
        if (link) {
            html += `<a href="${link}" class="toast-link">Restablecer contraseña</a>`;
        }
        html += `</div>`;
